...
$sql_dropdown = "SELECT student_id,first_name,last_name FROM students";
$result_delete = $conn->query($sql_dropdown);


if (isset($_POST['delete_student'])) {
    $student_id = $_POST['student_id'];

    // Perform a SQL query to delete the student based on their ID
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="view-tab" data-toggle="tab" href="#view" role="tab" aria-controls="view" aria-selected="true">View Students</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="delete-tab" data-toggle="tab" href="#delete" role="tab" aria-controls="delete" aria-selected="false">Delete Students</a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
            <!-- View Students Tab -->
            <div class="tab-pane fade show active" id="view" role="tabpanel" aria-labelledby="view-tab" style="margin-top:100px">
            <?php
           if ($result_view->num_rows > 0) {
            // Output students in a table
            echo '<table class="table table-striped">';
            echo '<thead><tr><th>Student ID</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Date of Birth</th><th>Department</th><th>Phone Number</th></tr></thead>';
            echo '<tbody>';
            ...
            <!-- Delete Students Tab -->
            <div class="tab-pane fade" id="delete" role="tabpanel" aria-labelledby="delete-tab" style="margin-top:100px">
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="student_id" name="student_id">
            ...
            <?php
            // Loop through the fetched students and create options in the dropdown
    ...
    <button type="submit" class="btn btn-danger" name="delete_student">Delete Student</button>
</form>
